...
//   const { uploadMatrimonialImage, deleteMatrimonialImage } = useAuth() as any;
...
//     useState<MatrimonialProfileData>(defaultProfile);
...
//     );
//     requireSection(hasGallery, weights.gallery, "Upload at least one photo");
...
//   const setProfileField = useCallback((path: string | string[], value: any) => {
//     setProfile((prev) => {
...
//         toast.error(error?.message || "Failed to load your matrimony profile.");
//         setProfile(createDefaultProfile());
//       } finally {
//         if (isMounted) {
...
//           toast.error(
//             "You are not allowed to save this profile. Please login again.",
//           );
//           if (typeof window !== "undefined") {
//             window.location.href = "/#login";
//           }
...
//               <QRCode value={publicProfileUrl} size={158} />
//             </div>
//             <div>
...
//                 Scan the QR or share the link below so family and matchmakers
//                 can view this profile.
//               </p>
//             </div>
//           </div>
