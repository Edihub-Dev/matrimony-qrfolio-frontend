...
import { blockUser, reportProfile, unblockUser } from "../lib/reportsApi";
              ...
              <div className="flex-1 text-center md:text-left">
                <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                  <div className="max-w-3xl mx-auto md:mx-0">
                    <p className="text-2xl sm:text-[30px] font-semibold leading-snug">
                ...
                >
                  ...
                  <div className="grid gap-3 text-xs text-rose-900 sm:grid-cols-2">
                    ...
                    <InfoTile
                      ...
                      value={(contact as any).aadhaarStatus as string}
