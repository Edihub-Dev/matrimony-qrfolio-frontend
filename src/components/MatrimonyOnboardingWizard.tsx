      ...
      try {
        ...
        if (result.ok && result.profile?.fullProfile) {
          ...
          setForm((prev) => ({
            ...
            aadhaarStatus: (contact as any).aadhaarStatus || prev.aadhaarStatus,
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <FancySelect
                      ...
                      placeholder="Select Aadhaar status"
                      columns={1}
                    />
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateField(
                          "manglik",
                          e.target.value as WizardFormState["manglik"]
                        )
                      }
                      className="w-full rounded-2xl border border-[#f2e6ea] bg-white px-4 py-3 text-sm text-[#2e1d22] focus:outline-none focus:ring-2 focus:ring-[#f07f9c]/70 focus:border-transparent"
                    >
                ...
                <div>
                  ...
                  !form.occupation ? (
                    <select
                      ...
                      className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                    >
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateField("favCanCook", e.target.value)}
                    className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                  >
                    <option value="">Can you cook?</option>
              ...
              <div className="space-y-3">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={form.partnerKundliAstro}
                      onChange={(e) =>
                        updateField("partnerKundliAstro", e.target.value)
                      }
                      className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                      placeholder="Match required, optional, not important, etc."
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-gray-600 mb-1">
                    ...
                    {[...SUBCASTE_OPTIONS, "Any"].includes(form.partnerCaste) ||
                    !form.partnerCaste ? (
                      <select
                        value={
                          [...SUBCASTE_OPTIONS, "Any"].includes(
                            form.partnerCaste
                          )
                            ? form.partnerCaste
                            : ""
                        ...
                        onChange={(e) => {
                          const next = e.target.value;
                          if (next === "__OTHER__") {
                            updateField("partnerCaste", "__OTHER__");
                          } else {
                            updateField("partnerCaste", next);
                          }
                        }}
                        className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                      >
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const val = e.target.value;
                          if (!val) {
                            updateField("partnerCaste", "");
                          } else {
                            updateField("partnerCaste", val);
                          }
                        }}
                        className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                        placeholder="Write caste preference"
                      />
                    )}
                  </div>
                  <div>
                    ...
                    !form.partnerDisability ? (
                      <select
                        ...
                        className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                      >
                        <option value="">Select disability preference</option>
                        {SPECIAL_NOTE_OPTIONS.map((opt) => (
                          <option key={opt} value={opt}>
                            {opt}
                          </option>
                    ...
                    {[...RELIGION_OPTIONS, "Any"].includes(
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          const next = e.target.value;
                          if (next === "__OTHER__") {
                            updateField("partnerReligion", "__OTHER__");
                          } else {
                            updateField("partnerReligion", next);
                          }
                        }}
                      >
                      ...
                      <input
                        type="text"
                        value={
                          form.partnerReligion === "__OTHER__"
                            ? ""
                            : form.partnerReligion
                        }
                        onChange={(e) => {
                          const val = e.target.value;
                          if (!val) {
                            updateField("partnerReligion", "");
                          } else {
                            updateField("partnerReligion", val);
                          }
                        }}
                        className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                        placeholder="Write religion preference"
                      />
                    )}
                  </div>
                  <div>
                    ...
                    {[...MOTHER_TONGUE_OPTIONS, "Any"].includes(
                      form.partnerMotherTongue
                    ) || !form.partnerMotherTongue ? (
                      <select
                        value={
                          [...MOTHER_TONGUE_OPTIONS, "Any"].includes(
                        ...
                        onChange={(e) => {
                          const next = e.target.value;
                          if (next === "__OTHER__") {
                            updateField("partnerMotherTongue", "__OTHER__");
                          } else {
                            updateField("partnerMotherTongue", next);
                          }
                        }}
                        className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                      >
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const val = e.target.value;
                          if (!val) {
                            updateField("partnerEduLevel", "");
                          } else {
                            updateField("partnerEduLevel", val);
                          }
                        }}
                        className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                        placeholder="Write education level"
                    ...
                    !form.partnerProfession ? (
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const val = e.target.value;
                          if (!val) {
                            updateField("partnerProfession", "");
                          } else {
                            updateField("partnerProfession", val);
                          }
                        }}
                        className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                    ...
                    !form.partnerEarning ? (
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const val = e.target.value;
                          if (!val) {
                            updateField("partnerEarning", "");
                          } else {
                            updateField("partnerEarning", val);
                          }
                        }}
                        className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 focus;border-rose-500"
                ...
                <div className="grid sm:grid-cols-3 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateField("partnerDiet", e.target.value)
                      }
                      className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateField("partnerSmoke", e.target.value)
                      }
                      className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateField("partnerDrink", e.target.value)
                      }
                      className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                    >
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-rose-100 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500"
                    placeholder="Short one-line introduction for your profile"
                  />
                </div>
                <p className="text-xs font-semibold text-gray-700 uppercase tracking-wide">
                  About you
