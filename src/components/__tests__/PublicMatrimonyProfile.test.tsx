...
import * as publicApi from "../../lib/publicMatrimonyApi";
import * as reportsApi from "../../lib/reportsApi";
import { PublicMatrimonyProfile } from "../PublicMatrimonyProfile";
...
describe("PublicMatrimonyProfile", () => {
  ...
  it("invokes blockUser when Block profile is clicked", async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/Block profile/i)).toBeInTheDocument();
    });
