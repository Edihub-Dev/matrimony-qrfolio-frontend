...
import { createPhonePePayment } from "@/lib/payments/paymentApi";
...
export const MembershipPlans = () => {
  ...
  return (
    <section
      id="plans"
      className="py-20 bg-gradient-to-b from-white to-rose-50/60 border-t border-rose-100/60"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="text-gray-600 text-sm sm:text-base">
            Start free, then upgrade for deeper insights, advanced QR designs
            and more media space when you need it.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="relative bg-white rounded-2xl border border-rose-200 shadow-lg shadow-rose-100 px-6 py-9 flex flex-col scale-[1.02]">
            ...
            <p className="text-sm text-gray-600 mb-6">
              For families actively sharing profiles with relatives, matchmakers
              and NRI contacts.
            </p>
            ...
            <div className="text-xs text-rose-600 mb-6">
          ...
          <div className="relative bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-8 flex flex-col">
            ...
            <p className="text-sm text-gray-600 mb-6">
              Best for NRI families, events or matchmakers managing many
              introductions.
            </p>
            <div className="flex items-baseline gap-2 mb-1">
